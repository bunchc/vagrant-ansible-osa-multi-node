...
vagrant pristine -f --no-provision && vagrant provision | tee build.log
...
build_time_start,host=lab-c.local value=${ts}
build_time_stop,host=lab-c.local value=${te}
build_time_total,host=lab-c.local value=${tt}"
